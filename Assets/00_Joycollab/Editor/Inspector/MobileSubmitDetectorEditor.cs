/// <summary>
/// Mobile 에서 InputField 의 Submit 을 탐지하는 'MobileSubmitDetector' 의 inspector 관리 클래스 
/// @author         : HJ Lee
...
{
    [CustomEditor(typeof(MobileSubmitDetector), true)]
    [CanEditMultipleObjects]
    public class MobileSubmitDetectorEditor : InputFieldEditor
    {
